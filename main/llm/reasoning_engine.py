...
from main.logger import logger_agent
from main.ml.predictor import NewsArticlePredictor
from main.rag.static.static_rag import StaticRAG
from main.rag.dynamic.dynamic_rag import DynamicRAG
from main.tools.content_extraction_tools import extract_content
import json
...
class ReasoningEngine:
    ...
    def __init__(
        ...
        try:
            from main.agent.workflow import create_workflow
    ...
    def stream_analyze(self, claim: str, thread_id: str):
        ...
        import re as _re
        from main.api.database import save_analysis
        ...
        yield _ev("progress", "🤖 Running ML baseline classifier...")
        ml_prediction = self._get_ml_prediction(claim)
